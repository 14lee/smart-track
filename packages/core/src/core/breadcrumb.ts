import { EVENT_TYPES, BREADCRUMB_TYPES } from '@smart-track/common';
import { validateOption, getTimestamp, _support } from '@smart-track/utils';
import { BreadcrumbData, InitOptions } from '@smart-track/types';
